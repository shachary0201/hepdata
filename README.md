...
Working with this particular file:
...
Main Steps (Valid for all cases):
...
If the local validation is successful, upload this .tar.gz file to the HEPData sandbox and submit it.
